...
@Component({
  selector: 'app-taches-manager',
  templateUrl: './taches-manager.component.html',
  styleUrls: ['./taches-manager.component.scss'],
  animations: [
...
export class TachesManagerComponent implements OnInit {
  nameTab=[];
  tab;
  id: number;
  taches;
...
console.log(this.ELEMENT_DATA,'tabbbbbb',typeof(this.ELEMENT_DATA),'type',this.ELEMENT_DATA[0],'index',this.ELEMENT_DATA.indexOf(tache))
